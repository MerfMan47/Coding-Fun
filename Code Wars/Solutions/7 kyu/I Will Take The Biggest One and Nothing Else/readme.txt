===================Notes===================
It took me longer to understand the
instructions than to solve the kata both
in linear time then to resolve it in
constant time using algorithmic methods.
===================Notes===================
